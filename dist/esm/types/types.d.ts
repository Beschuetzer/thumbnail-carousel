...
export declare enum ArrowButtonDirection {
    next = "next",
    previous = "previous"
}
export declare enum CarouselElement {
    /**
...
export declare enum CarouselSection {
    container = "container",
...
export declare enum CarouselVideoCurrentStateIndicatorButtonName {
    playIcon = "playIcon",
    pauseIcon = "pauseIcon"
}
