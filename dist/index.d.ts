...
import React__default, { CSSProperties, ElementType, ReactNode } from 'react';

type CarouselItemViewerToolbarProps = {
    currentVideoSection?: number;
    description: string;
    imageRef?: React__default.MutableRefObject<HTMLImageElement | undefined> | null;
    isProgressBarMouseDownRef?: React__default.MutableRefObject<boolean | undefined>;
    isVideo: boolean;
    itemContainerRef: React__default.MutableRefObject<HTMLDivElement | undefined> | null;
    onClose?: () => void;
    onNextItemClick?: () => void;
    onPreviousItemClick?: () => void;
    percent?: number;
    seekPercent?: number;
    setCurrentVideoSection?: React__default.Dispatch<React__default.SetStateAction<number>>;
    setPercent?: React__default.Dispatch<React__default.SetStateAction<number>>;
    setSeekPercent?: React__default.Dispatch<React__default.SetStateAction<number>>;
    toggleIsVideoPlaying?: (state?: boolean) => void;
    videoRef?: React__default.MutableRefObject<HTMLVideoElement | undefined> | null;
};

/**
*The first value is the description of the section and second value is either the duration or the start time (respectively).
**/
type CarouselVideoSection = [string, number] | [string, string];
type CarouselVideoOptions = {
    /**
...
declare const CarouselVideo: (props: CarouselVideoProps & CarouselItemProps & Pick<CarouselItemViewerToolbarProps, 'itemContainerRef'>) => React$1.JSX.Element;
...
declare enum CarouselVideoCurrentStateIndicatorButtonName {
    playIcon = "playIcon",
    pauseIcon = "pauseIcon"
}
declare enum SpacingDirection {
    bottom = "bottom",
    left = "left",
    right = "right",
    top = "top"
}
type CarouselColorOptions = {
    /**
...
type CarouselElementValueType = "min-width" | "max-width";
/**
*this can be any color string (e.g. `#abc123`, `rgba(255,0,122, .5)`, or `yellow`)
**/
type Color = string;
type CarouselElementColor = {
    color?: CarouselElementValue<Color>;
};
type CarouselElementSize = {
    /**
...
type CarouselElementViewingMode<T> = {
    /**
...
type CarouselElementValue<T> = CarouselElementViewingMode<T> | CarouselElementValueTuple<T>;
type CarouselElementValueTuple<T> = CarouselElementTuple<T> | T;
type CarouselElementTuple<T> = [NonNullable<T> | undefined, number?, CarouselElementValueType?][];
type CarouselItemViewerOptions = {
    /**
...
type CarouselItemViewerAspectRatioPreset = 'widescreen' | 'fullscreen';
type CarouselItemDisplayLocation = 'none' | 'above' | 'below';
type CarouselItemThumbnailPositioning = 'left' | 'center' | 'right';
type CarouselSections = {
...
type CarouselSectionsContainer = {
...
type CarouselSectionsNavigation = {
    /**
...
type CarouselSectionsVideoCurrentStateIndicator = {
    /**
...
type CarouselFontFamilyOptions = Exclusive<{
    /**
...
type CarouselHorizontalPaddingOptions = {
...
type CarouselVerticalPaddingOptions = {
...
type CarouselHorizontalMarginOptions = {
...
type CarouselVerticalMarginOptions = {
...
type CarouselActionOnActionCompleted = () => void;
type CarouselItemViewerActions = {
    /**
...
type CarouselElementCustomization = {
    /**
...
**/
type CarouselThumbnailBackgroundOptions = {
    /**
...
*Only applicable in fullscreen mode since thumbnails not visible otherwise
**/
type CarouselThumbnailBackground = {
    /**
...
*Only applicable in fullscreen mode since thumbnails not visible otherwise
**/
type CarouselThumbnailDescriptionOverlayOptions = {
    /**
...
type CarouselModalGetCodeSectionsInput = {
    /**
    *The lines
...
type CarouselModalGetCodeSectionInput = {
    text: string;
    marginTop?: number;
    tabCount?: number;
    tabSpacing?: number;
...
type KeyInput = ValidKey | KeyCombination;
...
type CarouselModalProps = Exclusive<{
    /**
...
type CarouselItemSourceMain = string | CarouselVideo;
...
declare const Carousel: (props: CarouselProps) => React$1.JSX.Element;
