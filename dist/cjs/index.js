...
var useSetVideoCurrentTime = function (input) {
    ...
    var lastRenderTimeoutRef = React$1.useRef();
    var lastDrawTimeRef = React$1.useRef(0);
    var drawSnapshot = React$1.useCallback(function (duration) {
        if (!video || percent === undefined || percent < 0 || !isFinite(duration) || !isFinite(percent))
            return;
        video.currentTime = percent * duration;
    }, [percent, video]);
    var handleDrawSnapshot = React$1.useCallback(function () {
...
var CarouselVideoProgressBarScreenshotViewer = function (props) {
    ...
    var screenShotTextContainerRef = React$1.useRef();
    var textTranslateOffsetRef = React$1.useRef({});
    var textTranslationAmountRef = React$1.useRef(TEXT_TRANSLATION_AMOUNT_REF_INITIAL);
    var videoThumbnailRef = React$1.useRef();
...
var useOnSwipe = function (input) {
    ...
    var lastCoordinateRef = React$1.useRef();
    var currentCoordinateRef = React$1.useRef();
    var startCoordinateRef = React$1.useRef();
    var endCoordinateRef = React$1.useRef();
    var mouseDownSourceElement = React$1.useRef();
    var mouseUpSourceElement = React$1.useRef();
    var isMobile = getIsMobile();
    var reset = React$1.useCallback(function () {
    ...
    var getShouldSkipCallback = React$1.useCallback(function (swipeDirection) {
        var _a;
    ...
    var handleMove = React$1.useCallback(function (e) {
    ...
    var handleClickStop = React$1.useCallback(function (e) {
    ...
    **/
    var handleSwiping = React$1.useCallback(function (e) {
        var _a, _b, _c, _d;
    ...
    var handleEnd = React$1.useCallback(function (e) {
        stopPropagation(e);
    ...
    var handleStart = React$1.useCallback(function (e) {
        stopPropagation(e);
        if (isDisabled)
            return;
...
var useOnResize = function (onResize) {
    var resizeIntervalRef = React$1.useRef(-1);
    var lastWidthRef = React$1.useRef(-1);
    React$1.useLayoutEffect(function () {
...
var useRecommendedAspectRatio = function (items) {
    var _a = React$1.useState(USE_RECOMMENDEDED_ASPECT_RATIO_INITIAL), recommendedAspectRatio = _a[0], setRecommendedAspectRatio = _a[1];
    var lowestRatioRef = React$1.useRef(5);
    var hasStartedRef = React$1.useRef(false);
    var imageCountRef = React$1.useRef(items.length);
    var imagesRef = React$1.useRef([]);
    var intervalRef = React$1.useRef();
    var optionsLogic = useBusinessLogic().optionsLogic;
    var setRatio = React$1.useCallback(function () {
...
var CarouselItemViewerContainer = React$1.forwardRef(function (props, ref) {
    ...
    var heightsRef = React$1.useRef([]);
    var intervalRef = React$1.useRef(-1);
    var resizeTimeOutRef = React$1.useRef();
    var hasCurrentItemIndexChangedRef = React$1.useRef(HAS_CURRENT_ITEM_INDEX_CHANGED_INITIAL);
    var currentInvervalRef = React$1.useRef(CURRENT_INTERVAL_INITIAL);
    var itemContainerRef = React$1.useRef(null);
    var lastViewportWidthRef = React$1.useRef(LAST_VIEWPORT_WIDTH_REF_INITIAL);
    var renderCountRef = useRenderCount();
    React$1.useImperativeHandle(ref, function () { return itemContainerRef.current; });
    var recommendedAspectRatio = useRecommendedAspectRatio(items);
    //#region Functions
    var setHeightAuto = React$1.useCallback(function () {
        var _a;
    ...
    **/
    var setHeightBasedOnAspectRatio = React$1.useCallback(function (aspectRatio) {
        var _a, _b;
    ...
    var startAutoHeightInterval = React$1.useCallback(function () {
    ...
    var resetAutoHeight = React$1.useCallback(function () {
    ...
    var setLastViewportWidth = React$1.useCallback(function () {
...
var CarouselItemViewerCustomButton = React$1.forwardRef(function (props, ref) {
    ...
    var optionsLogic = useBusinessLogic().optionsLogic;
    var classNamesToIncludeClassname = React$1.useMemo(function () { return classNamesToInclude.join(' '); }, [classNamesToInclude]);
    var defaultStyles = React$1.useMemo(function () { return StylingLogic.getColorStyle(fillColor, 'fill', {
...
var CloseButton = React$1.forwardRef(function (props, ref) {
...
var CarouselItemViewerShortcutIndicator = function (props) {
    ...
    var _h = React$1.useState(!isShortcutVisible || !actionName), hideShortcut = _h[0], setHideShortcut = _h[1];
    var isMobile = getIsMobile();
    React$1.useEffect(function () {
    ...
    //#region JSX
    var hiddenClassName = React$1.useMemo(function () { return isVisible ? "" : CLASSNAME__DISPLAY_NONE; }, [isVisible]);
...
var CarouselItemViewerCloseButton = React$1.forwardRef(function (props, ref) {
    ...
    var onClickLocal = React$1.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
...
var useSectionToValueMapping = function (input) {
    ...
    var currentItem = useCarouselContext().currentItem;
    var sections = ((currentItem === null || currentItem === void 0 ? void 0 : currentItem.video) || {}).sections;
    var checkIsVideoLoadedTimoutRef = React$1.useRef(-1);
    var sectionToValueMappingRef = React$1.useRef({});
    var mapSectionRanges = React$1.useCallback(function () {
        var _a, _b, _c;
    ...
    var validateSections = React$1.useCallback(function () {
        var _a, _b, _c;
...
var CarouselItemViewerProgressBar = function (props) {
    ...
    var currentItem = useCarouselContext().currentItem;
    var sections = ((currentItem === null || currentItem === void 0 ? void 0 : currentItem.video) || {}).sections;
    var areSectionsGiven = React$1.useMemo(function () { return sections && sections.length > 0; }, [sections]);
    var progressBarRef = React$1.useRef();
    ...
    var wasMouseUpJustTriggeredRef = React$1.useRef(false);
    var _a = React$1.useState(false), showDot = _a[0], setShowDot = _a[1];
    var _b = useBusinessLogic(), stylingLogic = _b.stylingLogic, optionsLogic = _b.optionsLogic;
    ...
    //#endregion
    //#region Functions/Handlers
    var getCurrentSection = React$1.useCallback(function (percent) {
    ...
    var getPercent = React$1.useCallback(function (e) {
        var _a, _b;
    ...
    var onMouseUp = React$1.useCallback(function (e) {
        var _a;
    ...
    var onMouseDown = React$1.useCallback(function (e) {
        var _a;
        e.stopPropagation();
        document.body.classList.remove(CLASSNAME__GRABBING);
    ...
    var onMouseLeave = React$1.useCallback(function (e) {
    ...
    var onMouseMove = React$1.useCallback(function (e) {
        if ((isProgressBarBeingHoveredRef === null || isProgressBarBeingHoveredRef === void 0 ? void 0 : isProgressBarBeingHoveredRef.current) !== undefined) {
    ...
    var onMouseMoveGlobal = React$1.useCallback(function (e) {
        var _a;
        if (!(isMouseDownRef === null || isMouseDownRef === void 0 ? void 0 : isMouseDownRef.current))
            return;
    ...
    var onMouseUpGlobal = React$1.useCallback(function (e) {
        if (!(isMouseDownRef === null || isMouseDownRef === void 0 ? void 0 : isMouseDownRef.current))
            return;
        onMouseUp(e);
    }, [isMouseDownRef, onMouseUp]);
    var onTouchStart = React$1.useCallback(function (e) {
        // console.log({start: e});
        e.stopPropagation();
        if (!(isMouseDownRef === null || isMouseDownRef === void 0 ? void 0 : isMouseDownRef.current)) {
            onMouseDown(e);
    ...
    var onTouchEnd = React$1.useCallback(function (e) {
        // console.log({end: e});
        e.stopPropagation();
        if (isMouseDownRef === null || isMouseDownRef === void 0 ? void 0 : isMouseDownRef.current) {
            isMouseDownRef.current = false;
    ...
    var onTouchMove = React$1.useCallback(function (e) {
        // console.log({move: e});
        e.stopPropagation();
        onMouseMove(e);
    }, [onMouseMove]);
    ...
    //#endregion
    //#region JSX
    var getBackgroundDiv = React$1.useCallback(function (_a) {
    ...
    var getForegroundDiv = React$1.useCallback(function (percent, left, index) {
    ...
    var getSeekDiv = React$1.useCallback(function (percent, left, index) {
        if (left === void 0) { left = 0; }
        if (index === void 0) { index = 0; }
...
var NextButton = React$1.forwardRef(function (props, ref) {
...
var CarouselItemViewerNextButton = React$1.forwardRef(function (props, ref) {
...
var PauseButton = React$1.forwardRef(function (props, ref) {
...
var CarouselItemViewerPauseButton = React$1.forwardRef(function (props, ref) {
...
var PlayButton = React$1.forwardRef(function (props, ref) {
    var _a = props.className, className = _a === void 0 ? CLASSNAME__BUTTON : _a, _b = props.onClick, onClick = _b === void 0 ? function () { return null; } : _b, fillColor = props.fillColor, _c = props.childStyle, childStyle = _c === void 0 ? {} : _c, _d = props.style, style = _d === void 0 ? {} : _d;
    var _e = useBusinessLogic(), stylingLogic = _e.stylingLogic, optionsLogic = _e.optionsLogic;
    var fillColorToUse = fillColor || optionsLogic.theme.colorFive;
...
var CarouselItemViewerPlayButton = React$1.forwardRef(function (props, ref) {
    var _a = props.actionName, actionName = _a === void 0 ? '' : _a, _b = props.isShortcutVisible, isShortcutVisible = _b === void 0 ? false : _b, _c = props.isVisible, isVisible = _c === void 0 ? true : _c, _d = props.onClick, onClick = _d === void 0 ? function () { return null; } : _d, _e = props.position, position = _e === void 0 ? 'center' : _e;
    var elementStylings = useCarouselContext().elementStylings;
...
var PreviousButton = React$1.forwardRef(function (props, ref) {
...
var CarouselItemViewerPreviousButton = React$1.forwardRef(function (props, ref) {
    var _a = props.actionName, actionName = _a === void 0 ? '' : _a, isShortcutVisible = props.isShortcutVisible, _b = props.onClick, onClick = _b === void 0 ? function () { return null; } : _b, _c = props.position, position = _c === void 0 ? 'center' : _c;
    var elementStylings = useCarouselContext().elementStylings;
...
var SeekBackButton = React$1.forwardRef(function (props, ref) {
...
var CarouselItemViewerSeekBackButton = React$1.forwardRef(function (props, ref) {
    ...
    var actionNameToUse = React$1.useMemo(function () { return "".concat(actionName, " ").concat(optionsLogic.videoSeekAmount, " seconds"); }, [actionName, optionsLogic.videoSeekAmount]);
...
var SeekForwardButton = React$1.forwardRef(function (props, ref) {
    var _a = props.className, className = _a === void 0 ? CLASSNAME__BUTTON : _a, fillColor = props.fillColor, _b = props.onClick, onClick = _b === void 0 ? function () { return null; } : _b, _c = props.childStyle, childStyle = _c === void 0 ? {} : _c, _d = props.style, style = _d === void 0 ? {} : _d;
    var _e = useBusinessLogic(), stylingLogic = _e.stylingLogic, optionsLogic = _e.optionsLogic;
    var fillColorToUse = fillColor || optionsLogic.theme.colorFive;
    var colorStyle = StylingLogic.getColorStyle(fillColorToUse, 'borderLeftColor', childStyle);
...
var CarouselItemViewerSeekForwardButton = React$1.forwardRef(function (props, ref) {
    var _a = props.actionName, actionName = _a === void 0 ? '' : _a, _b = props.isShortcutVisible, isShortcutVisible = _b === void 0 ? false : _b, _c = props.onClick, onClick = _c === void 0 ? function () { return null; } : _c, _d = props.position, position = _d === void 0 ? 'center' : _d;
    var elementStylings = useCarouselContext().elementStylings;
...
var LoadingSpinner = function (props) {
    ...
    var renderContent = React$1.useCallback(function (content) {
        if (!show)
            return null;
        switch (type) {
            case "roller":
...
var CarouselItemViewerToolbarPreview = function (props) {
    ...
    var shouldShowImageJSX = React$1.useMemo(function () { return !!(!getIsVideo(itemToShow) || srcThumbnail); }, [itemToShow, srcThumbnail]);
    //#endregion
    //#region JSX
    var className = React$1.useMemo(function () { return getClassname({ elementName: 'item-viewer-toolbar-preview' }); }, []);
    var isVisible = React$1.useMemo(function () { return optionsLogic.itemViewerPreviewIsVisible; }, [optionsLogic.itemViewerPreviewIsVisible]);
    var shortcutString = React$1.useMemo(function () { return getShortcutsString(shortcuts); }, [shortcuts]);
    var imageJSX = React$1.useMemo(function () { return (React.createElement("div", { style: stylingLogic.carouselItemViewerPreviewImageContainerStyle, className: "".concat(className, "-image-container") },
    ...
    var textJSX = React$1.useMemo(function () { return (React.createElement("div", { style: stylingLogic.carouselItemViewerPreviewImageDescriptionContainerStyle, className: "".concat(className, "-image-description") },
...
var useUpdateTimeString = function (input) {
    ...
    var checkVideoTimeStringIntervalRef = React$1.useRef();
    var checkVideoTimeStringCountRef = React$1.useRef(0);
    React$1.useEffect(function () {
        var _a;
...
var FullscreenButton = React$1.forwardRef(function (props, ref) {
...
var CarouselItemViewerFullscreenButton = React$1.forwardRef(function (props, ref) {
...
var CarouselModal = function (props) {
    ...
    var _c = React$1.useState(IS_VISIBLE_INITIAL), isVisible = _c[0], setIsVisible = _c[1];
    var modalRef = React$1.useRef();
    var modalHeightRef = React$1.useRef(MODAL_HEIGHT_INITIAL);
    var svgHref = ((elementStylings === null || elementStylings === void 0 ? void 0 : elementStylings.closeButton) || {}).svgHref;
    var isCustom = React$1.useMemo(function () { return !!children; }, [children]);
    ...
    var closeButtonColor = React$1.useMemo(function () { return optionsLogic.modalCloseButtonColor; }, [optionsLogic.modalCloseButtonColor]);
    var _e = React$1.useState(false), setShouldRerender = _e[1];
    ...
    var onCloseClick = React$1.useCallback(function (e) {
        onClick(e);
    ...
    var renderChildren = React$1.useCallback(function () {
        if (isModalMinimized) {
...
var CarouselItemViewerToolbar = React$1.forwardRef(function (props, ref) {
    var _a, _b;
    //#region Init
    ...
    var isProgressBarBeingHoveredRef = React$1.useRef(false);
    var shouldHideTimoutRef = React$1.useRef(-1);
    var previousButtonRef = React$1.useRef(null);
    var nextButtonRef = React$1.useRef(null);
    var closeButtonRef = React$1.useRef(null);
    var fullscreenButtonRef = React$1.useRef(null);
    var pauseButtonRef = React$1.useRef(null);
    var playButtonRef = React$1.useRef(null);
    var seekForwardButtonRef = React$1.useRef(null);
    var seekBackwardButtonRef = React$1.useRef(null);
    var showToolbarOnItemChangeTimeoutRef = React$1.useRef();
    var innerRef = React$1.useRef(null);
    React$1.useImperativeHandle(ref, function () { return innerRef.current; });
    ...
    var _o = React$1.useState(ToolbarPreviewDirection.none), previewDirection = _o[0], setPreviewDirection = _o[1];
    var _p = React$1.useState(false), isPreviousItemPreviewLoaded = _p[0], setIsPreviousItemPreviewLoaded = _p[1];
    var _q = React$1.useState(false), isNextItemPreviewLoaded = _q[0], setIsNextItemPreviewLoaded = _q[1];
    var _r = React$1.useState(false), showCloseButtonPopup = _r[0], setShowCloseButtonPopup = _r[1];
    var _s = React$1.useState(false), showFullscreenButtonPopup = _s[0], setShowFullscreenButtonPopup = _s[1];
    var _t = React$1.useState(false), showPauseButtonPopup = _t[0], setShowPauseButtonPopup = _t[1];
    var _u = React$1.useState(false), showPlayButtonPopup = _u[0], setShowPlayButtonPopup = _u[1];
    var _v = React$1.useState(false), showSeekForwardButtonPopup = _v[0], setShowSeekForwardButtonPopup = _v[1];
    var _w = React$1.useState(false), showSeekBackwardButtonPopup = _w[0], setShowSeekBackwardButtonPopup = _w[1];
    var _x = React$1.useState(false), showNextButtonPopup = _x[0], setShowNextButtonPopup = _x[1];
    var _y = React$1.useState(false), showPreviousButtonPopup = _y[0], setShowPreviousButtonPopup = _y[1];
    ...
    //#endregion
    //#region Functions/handlers
    var resetPreviewItems = React$1.useCallback(function () {
    ...
    var hideToolbar = React$1.useCallback(function () {
        var _a;
    ...
    var showToolbar = React$1.useCallback(function () {
        var _a;
    ...
    var handleAutoHide = React$1.useCallback(function (e) {
        var _a, _b;
    ...
    var onNextItemClickLocal = React$1.useCallback(function () {
        if (items.length <= 1)
            return;
    ...
    var onPreviousItemClickLocal = React$1.useCallback(function () {
        if (items.length <= 1)
            return;
    ...
    var onPauseClick = React$1.useCallback(function () {
        if (videoRef === null || videoRef === void 0 ? void 0 : videoRef.current) {
    ...
    var onPlayClick = React$1.useCallback(function () {
        if (videoRef === null || videoRef === void 0 ? void 0 : videoRef.current) {
    ...
    var onSeekBackClick = React$1.useCallback(function () {
        if (videoRef === null || videoRef === void 0 ? void 0 : videoRef.current) {
    ...
    var onSeekForwardClick = React$1.useCallback(function () {
        if (videoRef === null || videoRef === void 0 ? void 0 : videoRef.current) {
            videoRef.current.currentTime += optionsLogic.videoSeekAmount;
    ...
    var handleMouseLeave = React$1.useCallback(function (e) {
...
var CarouselVideoCurrentStateIndicatorPlayButton = React$1.forwardRef(function (props, ref) {
    var _a, _b;
    ...
    var stylingLogic = useBusinessLogic().stylingLogic;
    var fillColor = React$1.useMemo(function () { return stylingLogic.getVideoCurrentStateIndicatorForegroundColor(CarouselVideoCurrentStateIndicatorButtonName.playIcon); }, [stylingLogic]);
    var onClick = React$1.useCallback(function () { return null; }, []);
    return (!!svgHref ?
...
var CarouselVideoCurrentStateIndicatorPauseButton = React$1.forwardRef(function (props, ref) {
    var _a, _b;
    var options = useCarouselContext().options;
    ...
    var stylingLogic = useBusinessLogic().stylingLogic;
    var fillColor = React$1.useMemo(function () { return stylingLogic.getVideoCurrentStateIndicatorForegroundColor(CarouselVideoCurrentStateIndicatorButtonName.pauseIcon); }, [stylingLogic]);
    var onClick = React$1.useCallback(function () { return null; }, []);
    return (!!svgHref ?
        React.createElement(CarouselItemViewerCustomButton, { style: stylingLogic.carouselVideoCurrentStateIndicatorButtonStyle, ref: ref, onClick: onClick, xlinkHref: svgHref, useElementStyle: style, fillColor: fillColor }) :
...
var CarouselVideoCurrentStateIndicator = function (props) {
    ...
    var _b = React$1.useState(!isVideoPlaying), isAnimating = _b[0], setIsAnimating = _b[1];
    var timeoutRef = React$1.useRef(-1);
    React$1.useEffect(function () {
    ...
    var isAnimatingClassName = isAnimating && !optionsLogic.useDefaultVideoControls
        ...
        : '';
    var backgroundColorStyle = React$1.useMemo(function () { return StylingLogic.getColorStyle(optionsLogic.videoCurrentStateIndicatorBackgroundColor, 'backgroundColor'); }, [optionsLogic.videoCurrentStateIndicatorBackgroundColor]);
...
var useRerenderOnExitFullscreenMode = function () {
    ...
    var _a = React$1.useState(false); _a[0]; var setShouldRerender = _a[1];
...
var CarouselVideo = function (props) {
    ...
    var _j = React$1.useState(false), isLoaded = _j[0], setIsLoaded = _j[1];
    var _k = React$1.useState(PROGRESS_BAR_PERCENT_INITIAL_VALUE), percent = _k[0], setPercent = _k[1];
    var _l = React$1.useState(PROGRESS_BAR_PERCENT_INITIAL_VALUE), seekPercent = _l[0], setSeekPercent = _l[1];
    var _m = React$1.useState(CAROUSEL_VIDEO_CURRENT_SECTION_INITIAL), currentVideoSection = _m[0], setCurrentVideoSection = _m[1];
    var videoRef = React$1.useRef();
    var itemViewerToolbarRef = React$1.useRef();
    var isProgressBarMouseDownRef = React$1.useRef(false);
    var srcMainToUse = resolveSrcMain(srcMain, true);
    var type = React$1.useMemo(function () { return srcMainToUse === null || srcMainToUse === void 0 ? void 0 : srcMainToUse.slice((srcMainToUse === null || srcMainToUse === void 0 ? void 0 : srcMainToUse.lastIndexOf('.')) + 1); }, [srcMainToUse]);
    ...
    //#endregion
    //#region Functions/Handlers
    var toggleIsVideoPlaying = React$1.useCallback(function (state) {
    ...
    var playVideo = React$1.useCallback(function () {
        var _a, _b;
        if (videoRef.current) {
    ...
    var handleItemNavigation = React$1.useCallback(function () {
        var _a;
        setIsLoaded(false);
        if (videoRef.current) {
    ...
    var handleOnLoadedData = React$1.useCallback(function () {
        setIsLoaded(true);
        toggleIsVideoPlaying(false);
    }, [toggleIsVideoPlaying]);
    //#endregion
...
var CarouselImage = function (props) {
    ...
    var _d = React$1.useState(false), isLoaded = _d[0], setIsLoaded = _d[1];
    var _e = React$1.useState(false), setShouldRerender = _e[1];
    var imageRef = React$1.useRef();
    var itemViewerToolbarRef = React$1.useRef();
    var rerenderTimoutRef = React$1.useRef();
    ...
    useRerenderOnExitFullscreenMode();
    var onImageClick = React$1.useCallback(function (e) {
        if (e.detail === 2) {
...
var CarouselItemToRender = function (props) {
    ...
    var itemContainerRef = React$1.useRef();
    var isVideoStateChangeInitiatedInternallyRef = React$1.useRef(false);
    var isVideo = React$1.useMemo(function () { return getIsVideo(currentItem); }, [currentItem]);
    var _b = React$1.useState(false), isVideoPlaying = _b[0], setIsVideoPlaying = _b[1];
    var onClick = React$1.useCallback(function (e) {
        if (!isVideo)
            return;
        if (e.detail === 2) {
...
var ArrowButton = React$1.forwardRef(function (props, ref) {
...
var CarouselDots = function (props) {
    ...
    //#endregion
    //#region Handlers/Functions
    var onDotClick = React$1.useCallback(function (index) {
    ...
    //#endregion
    //#region JSX
    var useStyles = React$1.useMemo(function () { return StylingLogic.getColorStyle(fillColor, 'fill'); }, [fillColor]);
    var divStyles = React$1.useMemo(function () { return StylingLogic.getColorStyle(fillColor, 'backgroundColor', {
        opacity: CAROUSEL_DOT_OPACITY_DEFAULT,
    }); }, [fillColor]);
    var containerHeight = React$1.useMemo(function () { var _a; return (((_a = stylingLogic.getCarouselElementSizeStlye(CarouselElement.dots)) === null || _a === void 0 ? void 0 : _a.width) || CAROUSEL_DOT_HEIGHT_DEFAULT) * 2 / 3; }, [stylingLogic]);
    var containerWidth = React$1.useMemo(function () { var _a; return (((_a = stylingLogic.getCarouselElementSizeStlye(CarouselElement.dots)) === null || _a === void 0 ? void 0 : _a.width) || CAROUSEL_DOT_HEIGHT_DEFAULT) * 2 / 3; }, [stylingLogic]);
    var dotContainerSizeStyle = React$1.useMemo(function () { return ({
        width: CAROUSEL_DOT_WIDTH_DEFAULT + (Math.abs(containerWidth - CAROUSEL_DOT_WIDTH_DEFAULT) / CAROUSEL_DOT_WIDTH_DEFAULT),
        height: containerHeight,
    }); }, [containerHeight, containerWidth]);
    var dotSizeStyle = React$1.useMemo(function () { return ({
        width: containerHeight / 4,
        height: containerHeight / 4,
    }); }, [containerHeight]);
    var renderDots = React$1.useCallback(function () {
        var dots = [];
...
var CarouselItems = React$1.forwardRef(function (props, ref) {
    ...
    var stylingLogic = useBusinessLogic().stylingLogic;
    var itemsContainerOuterRef = React$1.useRef(null);
...
var CarouselContent = function (props) {
    ...
    var hasCalculatedNumberOfDotsRef = React$1.useRef(false);
    var hasCalculatedItemSpacingRef = React$1.useRef(false);
    var resizeWindowDebounceRef = React$1.useRef();
    var translationAmountDifferenceRef = React$1.useRef(0);
    var itemsContainerInnerRef = React$1.useRef(null);
    var previousCurrentItemIndexRef = React$1.useRef(CURRENT_ITEM_INDEX_INITIAL);
    var translationAmountChangeRef = React$1.useRef(TranslationAmountChange.none);
    var isLastPage = React$1.useMemo(function () { return currentPage + 1 === numberOfPages; }, [currentPage, numberOfPages]);
    var _e = React$1.useState(false), hasForcedRender = _e[0], setHasForcedRender = _e[1]; //used to force layout calculation initially
    var _f = React$1.useState(optionsLogic.getThumbnailSpacing()), interItemSpacing = _f[0], setInterItemSpacing = _f[1];
    var _g = React$1.useState(TRANSLATION_AMOUNT_INITIAL), translationAmount = _g[0], setTranslationAmount = _g[1];
    useOnSwipe({
    ...
    //#endregion
    //#region Functions/Handlers
    var getInterItemSpacing = React$1.useCallback(function () {
        var _a;
    ...
    var doTranslationAmountCommon = React$1.useCallback(function () {
        var _a;
    ...
    var getLastPageOffset = React$1.useCallback(function (numberOfWholeItemsThatCanFit, itemSize) {
        var offset = 0;
    ...
    var getTranslationAmountByCurrentPage = React$1.useCallback(function () {
        doTranslationAmountCommon();
        return currentPage * translationAmountDifferenceRef.current;
    }, [currentPage, doTranslationAmountCommon]);
    var getTranslationAmountByCurrentItemIndex = React$1.useCallback(function () {
    ...
    var setNumberOfDotsToDisplay = React$1.useCallback(function () {
...
var useBusinessLogic = function (input) {
    ...
    var _c = React$1.useState(getOptionsLogic({
        carouselContainerRef: carouselContainerRef,
    ...
    var _d = React$1.useState(getToolbarLogic({
        items: items,
    })), toolbarLogic = _d[0], setToolbarLogic = _d[1];
    var _e = React$1.useState(getToolbarActionsLogic({
        options: options,
        isFullscreenMode: isFullscreenMode,
    })), toolbarActionsLogic = _e[0], setToolbarActionsLogic = _e[1];
    var _f = React$1.useState(getStylingLogic({
        carouselContainerRef: carouselContainerRef,
        currentItem: currentItem,
...
var CarouselItemViewer = React$1.forwardRef(function (props, ref) {
    //#region Init
    var _a = useCarouselContext(), currentItem = _a.currentItem, isFullscreenMode = _a.isFullscreenMode;
    var stylingLogic = useBusinessLogic().stylingLogic;
    var isVisible = React$1.useMemo(function () { var _a; return ((_a = Object.keys(currentItem || {})) === null || _a === void 0 ? void 0 : _a.length) > 0 && isFullscreenMode; }, [currentItem, isFullscreenMode]);
    var innerRef = React$1.useRef(null);
    React$1.useImperativeHandle(ref, function () { return innerRef.current; });
    //#endregion
    //#region JSX
...
var CarouselProvider = function (props) {
    ...
    var _b = React$1.useState(itemsInput[0]), currentItem = _b[0], setCurrentItem = _b[1];
    var _c = React$1.useState(CURRENT_ITEM_INDEX_INITIAL), currentItemIndex = _c[0], setCurrentItemIndex = _c[1];
    var _d = React$1.useState(CURRENT_PAGE_INITIAL), currentPage = _d[0], setCurrentPage = _d[1];
    var _e = React$1.useState(CURRENT_VIDEO_CURRENT_TIME_DEFAULT), currentVideoCurrentTime = _e[0], setCurrentVideoCurrentTime = _e[1];
    var _f = React$1.useState(false), isFullscreenMode = _f[0], setIsFullscreenMode = _f[1];
    var _g = React$1.useState(MODAL_IS_MINIMIZED_INITIAL), isModalMinimized = _g[0], setIsModalMinimized = _g[1];
    var _h = React$1.useState(itemsInput), items = _h[0], setItems = _h[1];
    var _j = React$1.useState(ITEM_CONTAINER_HEIGHT_INITIAL), itemContainerHeight = _j[0], setItemContainerHeight = _j[1];
    var _k = React$1.useState(0), numberOfPages = _k[0], setNumberOfPages = _k[1];
    var _l = React$1.useState(optionsInput || {}), options = _l[0], setOptions = _l[1];
    var itemViewerRef = React$1.useRef(null);
    var currentItemToUse = React$1.useMemo(function () { return Object.keys(currentItem || {}).length > 0 ? currentItem : items[0]; }, [currentItem, items]);
    React$1.useEffect(function () {
...
function useCarouselContext() {
    return React$1.useContext(CarouselContext);
}
...
var Carousel = function (props) {
    ...
    var carouselContainerRef = React$1.useRef();
    var hiddenInputRef = React$1.useRef();
    ...
    var _a = React$1.useState(false), setShouldRerender = _a[1];
    useOnResize(function () {
        var _a, _b;
        setShouldRerender(function (current) { return !current; });
        (_b = (_a = document.body) === null || _a === void 0 ? void 0 : _a.style) === null || _b === void 0 ? void 0 : _b.removeProperty('cursor');
