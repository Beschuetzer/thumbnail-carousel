...
import {
  CarouselItemViewerActions,
  CarouselAction,
  CarouselActionOnActionCompleted,
  CarouselElement,
  KeyInput,
  ValidKey,
} from "../types";
...
export type ToolbarActionsLogicConstructor = {} & Pick<
...
export class ToolbarActionsLogic {
  ...
  constructor(constructor: ToolbarActionsLogicConstructor) {
    const { options, isFullscreenMode } = constructor;
    ...
    this._closeShortcut = {
      onActionCompleted:
        this._itemViewerShortcuts?.[CarouselElement.closeButton]
          ?.onActionCompleted,
      keys:
        this._itemViewerShortcuts?.[CarouselElement.closeButton]?.keys ||
        ITEM_VIEWER_CLOSE_SHORTCUTS,
    };
    this._nextItemShortcut = {
      onActionCompleted:
        this._itemViewerShortcuts?.[CarouselElement.nextButton]
          ?.onActionCompleted,
      keys:
        this._itemViewerShortcuts?.[CarouselElement.nextButton]?.keys ||
        ITEM_VIEWER_NEXT_ITEM_SHORTCUTS,
    };
    this._pauseShortcut = {
      onActionCompleted:
        this._itemViewerShortcuts?.[CarouselElement.pauseButton]
          ?.onActionCompleted,
      keys:
        this._itemViewerShortcuts?.[CarouselElement.pauseButton]?.keys ||
        ITEM_VIEWER_PLAY_SHORTCUTS,
    };
    this._playShortcut = {
      onActionCompleted:
        this._itemViewerShortcuts?.[CarouselElement.playButton]
          ?.onActionCompleted,
      keys:
        this._itemViewerShortcuts?.[CarouselElement.playButton]?.keys ||
        ITEM_VIEWER_PLAY_SHORTCUTS,
    };
    this._previousItemShortcut = {
      onActionCompleted:
        this._itemViewerShortcuts?.[CarouselElement.previousButton]
          ?.onActionCompleted,
      keys:
        this._itemViewerShortcuts?.[CarouselElement.previousButton]?.keys ||
        ITEM_VIEWER_PREVIOUS_ITEM_SHORTCUTS,
    };
    this._seekBackwardsShortcut = {
      onActionCompleted:
        this._itemViewerShortcuts?.[CarouselElement.seekBackButton]
          ?.onActionCompleted,
      keys:
        this._itemViewerShortcuts?.[CarouselElement.seekBackButton]?.keys ||
        ITEM_VIEWER_SEEK_BACKWARDS_SHORTCUTS,
    };
    this._seekForwardsShortcut = {
      onActionCompleted:
        this._itemViewerShortcuts?.[CarouselElement.seekForwardButton]
          ?.onActionCompleted,
      keys:
        this._itemViewerShortcuts?.[CarouselElement.seekForwardButton]?.keys ||
        ITEM_VIEWER_SEEK_FORWARDS_SHORTCUTS,
    };

    this.isPauseSeparate =
      !!this._itemViewerShortcuts[CarouselElement.pauseButton]?.keys;
  }
  ...
  getAllOnActionCompleted(): GetAllOnActionCompleted {
    return {
      ...
      [CarouselElement.previousButton]:
        this._previousItemShortcut.onActionCompleted,
      [CarouselElement.seekBackButton]:
        this._seekBackwardsShortcut.onActionCompleted,
      [CarouselElement.seekForwardButton]:
        this._seekForwardsShortcut.onActionCompleted,
    };
  }
  ...
  getClose(): GetIndividualResponse {
    ...
    return {
      onActionCompleted:
        this._closeShortcut.onActionCompleted || this._doNothing,
      keys: keysToUse,
    };
  }
  ...
  getNextItem(): GetIndividualResponse {
    ...
    return {
      onActionCompleted:
        this._nextItemShortcut.onActionCompleted || this._doNothing,
  ...
  getPause(): GetIndividualResponse {
    ...
    return {
      onActionCompleted:
        this._pauseShortcut.onActionCompleted || this._doNothing,
  ...
  getPlay(): GetIndividualResponse {
    ...
    return {
      onActionCompleted:
        this._playShortcut.onActionCompleted || this._doNothing,
  ...
  getPreviousItem(): GetIndividualResponse {
    ...
    return {
      onActionCompleted:
        this._previousItemShortcut.onActionCompleted || this._doNothing,
  ...
  getSeekForwards(): GetIndividualResponse {
    ...
    return {
      onActionCompleted:
        this._seekForwardsShortcut.onActionCompleted || this._doNothing,
  ...
  getSeekBackwards(): GetIndividualResponse {
    ...
    return {
      onActionCompleted:
        this._seekBackwardsShortcut.onActionCompleted || this._doNothing,
