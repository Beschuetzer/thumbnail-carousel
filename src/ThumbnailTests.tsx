...
const SECTIONS: Sections = [
  [
    ...
    [
      ...
      {
        label:
          "Display Current Item Below with Custom itemHeight and Thumbnail Size",
      ...
      },
      {
        ...
        jsx: React.cloneElement(
          layoutAboveCompletelyFlushAndSameBackgroundColor,
          {
            options: {
              ...layoutAboveCompletelyFlushAndSameBackgroundColor.props.options,
              layout: {
                ...layoutAboveCompletelyFlushAndSameBackgroundColor.props
                  .options.layout,
                itemDisplayLocation: "below",
              },
            },
      ...
      },
      {
        ...
        jsx: React.cloneElement(
          layoutAboveCompletelyFlushAndSameBackgroundColorProgressSpanWhole,
          {
            options: {
              ...layoutAboveCompletelyFlushAndSameBackgroundColorProgressSpanWhole
                .props.options,
      ...
      },
      {
        ...
        jsx: React.cloneElement(
          layoutAboveCompletelyFlushAndSameBackgroundColorAll,
          {
            options: {
              ...layoutAboveCompletelyFlushAndSameBackgroundColorAll.props
                .options,
              layout: {
                ...layoutAboveCompletelyFlushAndSameBackgroundColorAll.props
                  .options.layout,
      ...
      },
      {
        ...
        jsx: React.cloneElement(
          layoutAboveCompletelyFlushAndSameBackgroundColorWithCustomIcons,
          {
            options: {
              ...layoutAboveCompletelyFlushAndSameBackgroundColorWithCustomIcons
                .props.options,
      ...
      {
        label:
          "Display Below Custom Icons with Default Icons using Custom Colors",
        jsx: React.cloneElement(
          layoutAboveCompletelyFlushAndSameBackgroundColorWithCustomColors,
          {
            options: {
              ...layoutAboveCompletelyFlushAndSameBackgroundColorWithCustomColors
                .props.options,
