...
import { SpacingDirection, CarouselSection, CarouselItemProps } from "../types";
  ...
  useEffect(() => {
    ...
    for (const item of items) {
      try {
        ...
        if (!isImage && !item.srcThumbnail) continue;
        const imageSrc = item.srcThumbnail || (item.srcMain as string) || "";
