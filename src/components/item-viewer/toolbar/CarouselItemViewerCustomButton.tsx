...
export const CarouselItemViewerCustomButton = forwardRef<
  SVGSVGElement,
...
>((props, ref) => {
  ...
  const classNamesToIncludeClassname = useMemo(
    () => classNamesToInclude.join(" "),
    [classNamesToInclude],
  );
  ...
  return (
    <svg
      ...
      ref={ref}
      onClick={onClick}
      className={`${CLASSNAME__ITEM_VIEWER_BUTTON} ${classNamesToIncludeClassname} ${
        !showButton ? CLASSNAME__HIDDEN : ""
      }`}
    >
      <use
