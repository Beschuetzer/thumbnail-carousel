...
export const CarouselModal = (props: CarouselModalInternalProps) => {
  ...
  useSetCustomCssProperties({
    ...
    properties: [
      [
        CSS_CUSTOM_PROPERTY_MODAL_SCROLLBAR_BACKGROUND_COLOR,
        optionsLogic?.modalBackgroundColor,
      ],
      [
        CSS_CUSTOM_PROPERTY_MODAL_SCROLLBAR_FOREGROUND_COLOR,
        optionsLogic?.modalTextColor,
      ],
      [
        CSS_CUSTOM_PROPERTY_MODAL_OPACITY_MINIMIZED,
        optionsLogic?.modalOpacityWhenMinimized,
      ],
    ],
  });
  //#endregion
  ...
  useEffect(() => {
    ...
    currentItem,
    currentItemIndex,
    optionsLogic.modalMaintainMinimizedStateAcrossItems,
    setIsModalMinimized,
  ]);
      ...
      !!svgHref ? (
        <CarouselItemViewerCustomButton
          ...
          style={{
            ...
            ...(closeButtonTop ? { top: closeButtonTop } : {}),
          }}
        />
      ) : (
        <CloseButton
  ...
  return (
    <div
      ...
      style={stylingLogic.getCarouselModalStyle(
        (shouldHideWhenMinimized && isModalMinimized) ||
          isVideoPlaying ||
          !isVisible ||
