...
export const CAROUSEL_MODAL_WIDTH_DEFAULT = "min(70ch, 100%)";
...
export const CAROUSEL_ITEM_VIEWER_PREVIEW_IMAGE_POSITION_DEFAULT = "top";
...
export const CAROUSEL_VIDEO_SCREENSHOT_VIEWER_WIDTH_WITH_SPACING_DEFAULT = CAROUSEL_VIDEO_SCREENSHOT_VIEWER_WIDTH_DEFAULT + CAROUSEL_ITEM_SPACING_DEFAULT * 2
...
export const CAROUSEL_BORDER_RADIUS_DEFAULT = 0;
...
export const ITEM_VIEWER_ASPECT_RATIO_DEFAULT = 0.5;
...
export const MODAL_MAINTAIN_MINIMIZED_STATE_DEFAULT = true;
