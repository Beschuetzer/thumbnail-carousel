...
describe("getCurrentValue", () => {
  ...
  beforeEach(() => {
    ...
    itemsWithBooleans = [
      ...
      [true],
      [true, 900, undefined],
      [false, 1200, "min-width"],
      [false, 750],
    ];
    itemsWithObjects = [
      [{ key: false }, 500, "max-width"],
      [{ key: true }],
      [{ key: 1 }, 900, undefined],
      [{ key: 2 }, 1200, "min-width"],
      [{ key: "test" }, 750],
    ];
    itemBasic = 10;
  });
  ...
  it("Picks Basic Item", () => {
    ...
    const actual = getCurrentValue(itemBasic, defaultNumberValue, true);
  ...
  it("Picks Default at gap start", () => {
    ...
    const actual = getCurrentValue(itemsWithGap, defaultNumberValue, true);
  ...
  it("Value Picking Lowest", () => {
    ...
    const actual = getCurrentValue(itemsWithNoGap, defaultNumberValue, true);
  ...
  it("Handles Object Types", () => {
    ...
    const actual = getCurrentValue(itemsWithObjects, defaultObjectValue, true);
